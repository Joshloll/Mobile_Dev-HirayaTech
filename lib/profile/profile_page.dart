...
class _ProfilePageState extends State<ProfilePage> with SingleTickerProviderStateMixin {
  ...
  Widget _buildProfileHeader() { return Container( color: Colors.white, padding: const EdgeInsets.symmetric(horizontal: 16.0), child: Column( children: [ CircleAvatar( radius: 40, backgroundImage: NetworkImage(currentUser.avatarUrl), ), const SizedBox(height: 12), Text( currentUser.name, style: GoogleFonts.splineSans(fontWeight: FontWeight.bold, fontSize: 22), ), const SizedBox(height: 4), Text('Member since 2024', style: TextStyle(color: Colors.grey.shade600)), ], ), ); }
